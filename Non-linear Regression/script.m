...
%% title
rs = calInput_nominator( UI_matrix_chosen, title_matrix, train, test );
save(['data/', name, '/title.mat'], 'rs', '-v7.3');
rs = calInput_denominator( UI_matrix_chosen, title_matrix, train, test );
save(['data/', name, '/title_den.mat'], 'rs', '-v7.3');
% clear title_matrix
disp('title done!')

%% tag
rs = calInput_nominator( UI_matrix_chosen, tag_matrix, train, test );
save(['data/', name, '/tag.mat'], 'rs', '-v7.3');
rs = calInput_denominator( UI_matrix_chosen, tag_matrix, train, test );
save(['data/', name, '/tag_den.mat'], 'rs', '-v7.3');
% clear tag_matrix
disp('tag done!')

%% year
rs = calInput_nominator( UI_matrix_chosen, year_matrix, train, test );
save(['data/', name, '/year.mat'], 'rs', '-v7.3');
rs = calInput_denominator( UI_matrix_chosen, year_matrix, train, test );
save(['data/', name, '/year_den.mat'], 'rs', '-v7.3');
% clear year_matrix
disp('year done!')

%% genre
rs = calInput_nominator( UI_matrix_chosen, genre_matrix, train, test );
save(['data/', name, '/genre.mat'], 'rs', '-v7.3');
rs = calInput_denominator( UI_matrix_chosen, genre_matrix, train, test );
