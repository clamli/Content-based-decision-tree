...
for i = 1:10
    ...
    save(['data/UI_matrix/UI_matrix_', num2str(i), '_train.mat'], 'UI_matrix');
    UI_matrix = UI_matrix_test(startPos:endPos,:); 
    save(['data/UI_matrix/UI_matrix_', num2str(i), '_test.mat'], 'UI_matrix');
